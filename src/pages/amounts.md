...
---
## Amounts & Quantities (EN • DE • IT • GR • BG • SR)
...
|---|---|---|---|---|---|---|
| 🎚️ Pretty/quite | pretty; quite | ziemlich; ganz | abbastanza; piuttosto | αρκετά; πολύ | доста; съвсем | prilično; sasvim |
| 🎚️ Likely | likely; probably | wahrscheinlich | probabilmente | μάλλον; πιθανότατα | вероятно | verovatno |
| 🎚️ Sort of | sort of; kind of | so irgendwie; sozusagen | un po'; tipo | κάπως; τύπου | като че ли; донякъде | nekako; otprilike |
| 📈 Most of | most of | die meisten von | la maggior parte di | οι περισσότεροι; το μεγαλύτερο μέρος | повечето от | većina |
| 📈 The most | the most | das meiste; am meisten | il più; di più | το πιο πολύ; περισσότερο | най-много | najviše |
| 📉 The least | the least; the one I know the least | das wenigste; am wenigsten | il meno; quello che conosco meno | το λιγότερο; αυτό που ξέρω λιγότερο | най-малко; това което знам най-малко | najmanje; ono što najmanje znam |
| 📉 At least | at least | mindestens; wenigstens | almeno | τουλάχιστον | поне | bar; najmanje |
| 📉 At most/max | at most; maximum | höchstens; maximal | al massimo | το πολύ; μέγιστο | най-много; максимум | najviše; maksimalno |
| 📉 At minimum | at minimum | zumindest; minimal | al minimo | τουλάχιστον; ελάχιστο | минимум; поне | najmanje; minimalno |
| 🧼 Completely | completely | völlig; vollständig | completamente | εντελώς | напълно | potpuno |
| 🧼 Fully | fully | vollständig; voll | pienamente | πλήρως | изцяло | potpuno |
| 🟨 Almost | almost; nearly | fast; beinahe | quasi | σχεδόν | почти | skoro |
| 🔄 Often | often | oft | spesso | συχνά | често | često |
| 🚀 Insanely | insanely | wahnsinnig | follemente | τρελά | безумно | ludo; suludo |
| 🚀 Extremely | extremely | extrem; äußerst | estremamente | εξαιρετικά; πάρα πολύ | изключително | izuzetno |
| 🇩🇪 Significantly/much | significantly; much more | wesentlich mehr | molto di più | πολύ περισσότερο | значително повече | značajno; mnogo više |
| 🇩🇪 Absolutely/must | absolutely; must | unbedingt | assolutamente | απαραίτητα | непременно | apsolutno; obavezno |
| 🚀 So much | so much | so sehr | così tanto | τόσο πολύ | толкова много | toliko |
| 😎 So cool/strong | so cool/strong | so cool/stark | così figo/forte | τόσο ωραίο/δυνατό | толкова яко/силно | tako kul/jako |
...
| Concept | EN | DE | IT | GR | BG | SR |
|---|---|---|---|---|---|---|
| ⏳ It would take… | it would take X (time/effort) | es würde X dauern/kosten | ci vorrebbero X | θα χρειαζόταν Χ | би отнело Х | trebalo bi X (vremena/truda) |
| 📦 Amount/quantity | amount; quantity | Menge | quantità | ποσότητα | количество | količina |
| ✅ Sufficient | sufficiently; enough | ausreichend | sufficientemente | επαρκώς; αρκετά | достатъчно | dovoljno |
| ❌ Insufficient | insufficient | unzureichend; nicht genügend | insufficiente | ανεπαρκές | недостатъчен | nedovoljno |

### Additional expressions
| Concept | EN | DE | IT | GR | BG | SR |
|---|---|---|---|---|---|---|
| 🚀 So much/many | so much; so many | so viel; so viele | così tanto; così tanti | τόσο πολύ; τόσα πολλά | толкова много | toliko |
| 📉 At least like... | at least like... | wenigstens so... | almeno come... | τουλάχιστον σαν... | поне като... | bar kao... |
| 🔢 From X to Y | from 1 to 10 | von 1 bis 10 | da 1 a 10 | από το 1 έως το 10 | от 1 до 10 | od 1 do 10 |
| 🤏 A little something | a little something | ein bisschen was; etwas kleines | qualcosina | κάτι λιγάκι | нещо малко | nešto malo |

### Additional expressions
| Concept | EN | DE | IT | GR | BG | SR |
|---|---|---|---|---|---|---|
| 🚀 Hardest ever | that's the hardest ever | das ist das Schwerste überhaupt | è la cosa più difficile mai | αυτό είναι το πιο δύσκολο ποτέ | това е най-трудното някога | to je najteže ikad |
| 🎯 Even (emphasis) | even he... | sogar er... | perfino lui... | ακόμη και αυτός... | даже той... | čak i on... |
| 📊 More/less than | more than; less than | mehr als; weniger als | più di; meno di | περισσότερο από; λιγότερο από | повече от; по-малко от | više od; manje od |
| 👥 All of them are X | all of them are X | alle sind X | tutti loro sono X | όλοι τους είναι X | всички те са X | svi su oni X |
| ❌ No longer | no longer | nicht mehr | non più | δεν... πια | вече не | ne više |
| 📏 As much as | as much as | so viel wie | tanto quanto | όσο | толкова колкото | onoliko koliko |
| 📉 As little as | as little as | so wenig wie | così poco come | όσο λίγο | толкова малко колкото | onoliko malo koliko |
