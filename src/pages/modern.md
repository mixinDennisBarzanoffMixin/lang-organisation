...
---
## Modern & Colloquial Expressions (EN • DE • IT • GR • BG • SR)
...
|---|---|---|---|---|---|---|
| 🤷 I don't care | I don't care; whatever | mir egal; was auch immer | non mi importa; qualsiasi cosa | δεν με νοιάζει; ό,τι να 'ναι | все ми е едно; каквото и да е | baš me briga; svejedno mi je |
...
| Concept | EN | DE | IT | GR | BG | SR |
|---|---|---|---|---|---|---|
| 🇩🇪 Just enough/barely | just enough; barely | eben nur | proprio giusto | μόλις που | едва-едва | jedva; tek toliko |
| 🇮🇹 Little thing | a little thing | ein kleines Ding | qualcosina | κάτι μικρό | нещо малко | sitnica |
| 🇮🇹 Viceversa | vice versa | umgekehrt | viceversa | αντίστροφα | обратно | obrnuto |
| 🇮🇹 It came to me | it came to me (a curiosity, idea) | mir ist eingefallen | mi è venuta/o (una curiosità) | μου ήрθε | дойде ми (любопитство) | palo mi je na pamet |
| 🇮🇹 Randomly/carelessly | like that, just randomly | einfach so, zufällig | così a cazzo | έτσι απλά, τυχαία | така си, случайно | tako nasumično; bezveze |
| 🇮🇹 Back here/to origin | back here; to the origin | zurück hierher; zum Ursprung | al ecco; sono tornato | πίσω εδώ | обратно тук | nazad ovamo; do porekla |
...
| Concept | EN | DE | IT | GR | BG | SR |
|---|---|---|---|---|---|---|
| 🇩🇪 Actually/indeed | actually; indeed | ja (particle) | infatti | στην πραγματικότητα | всъщност | zapravo; zaista |
| 🇩🇪 Either can or can't | either can or can't | kann oder eben nicht kann | o può o non può | είτε μπορεί είτε δεν μπορεί | или може, или не може | ili može ili ne može |
| 🇩🇪 Around/about | around it; about that | drumherum | intorno a quello | γύρω από αυτό | около това | oko toga |
| 🇩🇪 Meanwhile even | meanwhile even | inzwischen sogar | nel frattempo persino | στο μεταξύ ακόμα | междувременно дори | u međuvremenu čak |
| 🇩🇪 Any random | any random thing | beliebige | qualsiasi cosa a caso | οτιδήποτε τυχαίο | някакво си | bilo koji |

### Time expressions
| Concept | EN | DE | IT | GR | BG | SR |
|---|---|---|---|---|---|---|
| ⏰ For the past few days | for the past few days | seit ein paar Tagen | da qualche giorno | εδώ και λίγες μέρες | от няколко дни насам | poslednjih nekoliko dana |
| ⏰ Once upon a time | once upon a time there was/had to be | es war einmal; da musste mal | c'era una volta; doveva esserci una volta | κάποτε υπήρχε/έπρεπε | по едно време имаше/трябваше | jednom davno beše/morao je biti |
| ⏰ I woke up at 5 o'clock *sharp* | I woke up at 5 o'clock sharp | ich bin um 5 Uhr *pünktlich* aufgewacht | mi sono svegliato alle 5 *in punto* | ξύπνησα στις 5 η ώρα *παρά* | събудих се в 5 часа *точно* | probudio sam se u 5 sati *tačno* |

### Additional expressions
| Concept | EN | DE | IT | GR | BG | SR |
|---|---|---|---|---|---|---|
| 🎯 He will do X, *while* we... | he will do X, while we... | er wird X machen, *während* wir... | lui farà X, *mentre* noi... | αυτός θα κάνει X, *ενώ* εμείς... | той ще прави X, *а* ние... | on će raditi X, *dok* mi... |
| 🇮🇹 If X, then we do/say | if X, then we do/say | wenn X, dann machen/sagen wir | se X, allora si fa/si dice | αν X, τότε κάνουμε/λέμε | ако X, тогава правим/казваме | ako X, onda radimo/kažemo |
| 🎭 Like actually... | like actually... | wie wirklich... | tipo davvero... | σαν να είναι πραγματικά... | като че ли наистина... | kao zapravo... |
| 🎯 As you are doing X | as you are doing X | während du X machst | mentre fai X | καθώς κάνεις X | докато правиш X | dok radiš X |
| 🔄 Alongside X is Y | alongside X is Y | neben X ist Y | accanto a X c'è Y | δίπλα στο X είναι το Y | заедно с X е Y | pored X je Y |

### Truly casual/modern expressions
| Concept | EN | DE | IT | GR | BG | SR |
|---|---|---|---|---|---|---|
| 👥 And I'm with him, right... | and I'm with him, right... | und ich bin bei ihm, oder... | e io sto con lui, no... | και εγώ είμαι μαζί του, έτσι... | и аз съм с него, нали... | i ja sam sa njim, jel da... |
...
| 🧰 Do the job (suffice) | it does the job; to do the job | tut seinen Zweck; die Arbeit machen | fa il suo dovere; fare il lavoro | κάνει τη δουλειά του; να κάνω τη δουλειά | върши работа; да свърша работата | vrši posao; odraditi posao |
| 🇧🇬 You know/have/can it | you know/have/can it; if not, can't rely on it | du kennst/hast/kannst es; sonst unzuverlässig | lo sai/hai/puoi; se no, non affidabile | το ξέρεις/έχεις/μπορείς· αλλιώς δεν βασίζεσαι | я го знаеш/имаш/можеш· иначе не можеш да разчиташ | znaš/imaš/možeš to; inače se ne možeš osloniti na to |
...
| Concept | EN | DE | IT | GR | BG | SR |
|---|---|---|---|---|---|---|
| 🔥 Fucking (intensifier) | fucking… (you don't fucking know) | verdammt/scheiß… | cazzo… | γαμημένος/α… | чертов/а… | jebeni... (jebeno ne znaš) |
