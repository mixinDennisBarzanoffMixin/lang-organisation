...
---
## Time Expressions (EN • DE • IT • GR • BG • SR)
...
| 🇩🇪 Haven't responded so far | they haven't responded so far | sie haben bislang nicht geantwortet | non hanno ancora risposto | δεν έχουν απαντήσει ακόμα | все още не са отговорили | do sada nisu odgovorili |
...
| Concept | EN | DE | IT | GR | BG | SR |
|---|---|---|---|---|---|---|
| 🕐 In the meantime | in the meantime | inzwischen; unterdessen | nel frattempo | στο μεταξύ | междувременно | u međuvremenu |
| ↔️ Between X and Y | between X and Y | zwischen X und Y | tra X e Y | ανάμεσα σε X και Y | между X и Y | između X i Y |
| ⏱️ During | during | während | durante | κατά τη διάρκεια | по време на | tokom; za vreme |
...
| 🇧🇬 Should have X | should have X | hätte X sollen | avrebbe dovuto X | θα έπρεπε να X | би трябвало да X | trebalo bi da X |
...
| 🔜 From now on | from now on | von jetzt an | d'ora in poi | από τώρα και μετά | отсега нататък | od sada |
